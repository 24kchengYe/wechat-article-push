...
```bash
cp "~/.claude/skills/wechat-office-push/assets/bcl_qrcode.jpeg" "<output_dir>/<paper_subfolder>/bcl_qrcode.jpeg"
cp "~/.claude/skills/wechat-office-push/assets/bcl_logo.png" "<output_dir>/<paper_subfolder>/bcl_logo.png"
```
...
```bash
cp "~/.claude/skills/wechat-office-push/assets/bcl_qrcode.jpeg" "<output_dir>/bcl_qrcode.jpeg"
cp "~/.claude/skills/wechat-office-push/assets/bcl_logo.png" "<output_dir>/bcl_logo.png"
```
